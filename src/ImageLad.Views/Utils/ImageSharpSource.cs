...
namespace ImageLad.Views.Utils;

/// <summary>
///     reference article: http://www.i-programmer.info/programming/wpf-workings/822
///     reference to what needs to be implemented:
///     https://blogs.msdn.microsoft.com/dwayneneed/2008/06/20/implementing-a-custom-bitmapsource/
/// </summary>
    ...
    where TPixel : unmanaged, IPixel<TPixel>
{
    ...
    public ImageSharpSource(
        ...
        int height)
    {
        _source = new Image<TPixel>(width, height);
    }
    ...
    {
        return new ImageSharpSource<TPixel>();
    }
        ...
        int offset)
    {
        ...
        checked
        {
            ...
            if (offsetInBytes >= bufferSize) throw new IndexOutOfRangeException();
    ...
    private void CopyPixelsCore(
        Int32Rect sourceRect, int stride,
        int bufferSize,
        IntPtr buffer)
    {
        unsafe
