...
{
    public sealed class SKBitmapBox : FrameworkElement
    {
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register(
                nameof(Source), typeof(object), typeof(SKBitmapBox),
                new PropertyMetadata(
                    null, (s, e) => ((SKBitmapBox)s).OnBitmapChanged(e)));

        public static readonly DependencyProperty StretchProperty =
            DependencyProperty.Register(
                nameof(Stretch), typeof(Stretch), typeof(SKBitmapBox),
                new PropertyMetadata(
                    Stretch.Uniform, (s, e) => ((SKBitmapBox)s).InvalidateVisual()));

        public static readonly DependencyProperty HorizontalContentAlignmentProperty =
            DependencyProperty.Register(
                nameof(HorizontalContentAlignment), typeof(HorizontalAlignment), typeof(SKBitmapBox),
                new PropertyMetadata(
                    HorizontalAlignment.Center, (s, e) => ((SKBitmapBox)s).InvalidateVisual()));

        public static readonly DependencyProperty VerticalContentAlignmentProperty =
            DependencyProperty.Register(
                nameof(VerticalContentAlignment), typeof(VerticalAlignment), typeof(SKBitmapBox),
                new PropertyMetadata(
